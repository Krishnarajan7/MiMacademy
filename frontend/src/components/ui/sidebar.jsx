...
const SidebarMenuBadge = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      "absolute right-1 top-1.5 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium tabular-nums text-sidebar-foreground select-none pointer-events-none",
